...
#ifndef BMAlgorithm_Recycle_5_h
#define BMAlgorithm_Recycle_5_h
...
namespace badminton {
    ...
    public:
        ...
        void get_four_players_of_a_match_5(vector<string> list_of_players,
        ...
        void send_scores_of_a_match_5(int id_of_match,
        ...
        void get_match_results_5(vector<string> list_of_players,
                                 ONE_MATCH all_matches[_RECYCLE_5_NUM_OF_MATCH_],
                                 MATCH_RESULTS* match_results);
        
        
        void print_all_teams_of_match_5(PLAYERS_OF_ONE_MATCH* players_of_match);
        
        void print_match_results_5(MATCH_RESULTS* match_results);
...
#endif /* BMAlgorithm_Recycle_5_hpp */
