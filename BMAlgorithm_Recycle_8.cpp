...
#include "BMAlgorithm_Recycle_8.h"
#include <iostream>
#include <vector>
#include <fstream>
#include <map>
...
namespace badminton {
    ...
    void BMA_8::get_four_players_of_a_match(vector<string> list_of_players,
    ...
    void BMA_8::send_scores_of_a_match(int id_of_match,
    ...
    void BMA_8::get_match_results(vector<string> list_of_players,
    ...
    void BMA_8::print_all_teams_of_match(PLAYERS_OF_ONE_MATCH* players_of_match)
    {
        unsigned i;
        for (i = 0; i < _RECYCLE_8_NUM_OF_MATCH_; i++)
        {
    ...
    void BMA_8::print_match_results(MATCH_RESULTS* match_results)
    {
        unsigned i;
