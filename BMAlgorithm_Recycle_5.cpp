...
#include "BMAlgorithm_Recycle_5.h"


namespace badminton {
    void BMA_5::get_four_players_of_a_match_5(vector<string> list_of_players,
                                              ONE_MATCH* all_matches)
    {
        ...
        all_matches[1].players_of_one_match.first_pair_of_players[0] = list_of_players[1];
        all_matches[1].players_of_one_match.first_pair_of_players[1] = list_of_players[2];
        all_matches[1].players_of_one_match.second_pair_of_players[0] = list_of_players[4];
        ...
        all_matches[2].players_of_one_match.first_pair_of_players[1] = list_of_players[4];
        ...
        all_matches[3].players_of_one_match.first_pair_of_players[0] = list_of_players[0];
        all_matches[3].players_of_one_match.first_pair_of_players[1] = list_of_players[2];
        all_matches[3].players_of_one_match.second_pair_of_players[0] = list_of_players[1];
        all_matches[3].players_of_one_match.second_pair_of_players[1] = list_of_players[4];
        ...
        all_matches[4].players_of_one_match.second_pair_of_players[0] = list_of_players[4];
        all_matches[4].players_of_one_match.second_pair_of_players[1] = list_of_players[2];
        
    }
    
    
    void BMA_5::send_scores_of_a_match_5(int id_of_match,
    ...
    void BMA_5::get_match_results_5(vector<string> list_of_players,
                                    ONE_MATCH all_matches[_RECYCLE_5_NUM_OF_MATCH_],
    ...
    void BMA_5::print_all_teams_of_match_5(PLAYERS_OF_ONE_MATCH* players_of_match)
    {
        unsigned i;
        for (i = 0; i < _RECYCLE_5_NUM_OF_MATCH_; i++)
        {
    ...
    void BMA_5::print_match_results_5(MATCH_RESULTS* match_results)
    {
        unsigned i;
